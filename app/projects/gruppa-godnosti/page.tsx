          ...
          <div className="space-y-10">
            {teamGroups.map((group) => (
              <div key={group.heading}>
                <h3 className="text-xs font-medium uppercase tracking-widest text-neutral-400 mb-3 pb-3 border-b border-neutral-100">
                  {group.heading}
                </h3>
                <div className="divide-y divide-neutral-100">
                  {group.members.map((member) => (
                    <div key={member.name} className="py-5 flex flex-col sm:flex-row gap-4 sm:gap-12">
